...
namespace CursosAPI.Services
{
    ...
    {
        Task<List<Inscripcion>> GetAllAsync(string? estado = null, int? progresoMinimo = null, DateTime? fechaDesde = null, DateTime? fechaHasta = null, string? orderBy = null, bool descending = false);
